...
namespace BE_API.Service.IService
{
    ...
    {
        Task<PagedResult<BusAssignmentDto>> SearchAsync(string? keyword, long? busId, long? routeId, long? driverId, long? teacherId, DateTime? activeDate, int page, int pageSize);
